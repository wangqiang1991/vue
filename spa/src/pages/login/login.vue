<template>
  <div class="login-container">
    <el-form class="card-box login-form" autoComplete="on" :model="loginForm"  ref="loginForm" label-position="left">
      <h1 class="title">构巢后台管理系统登录</h1>

      <el-form-item prop="username">
        <span class="svg-container svg-container_login">
          <icon-svg icon-class="user" />
        </span>
        <el-input name="username" type="text" v-model="loginForm.loginName" autoComplete="on" placeholder="帐号" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleLogin() {
      ...
      this.http.post(this).url(config.login).params({
