    ...
    <div id="putStorageStatistics_vue" class="app-container calendar-list-container">
      ...
      <div class="gc-praiselist_content_list" style="margin-top:15px;">
        ...
        <el-row :gutter="24">
          <el-col :span="7">
            <div class="count">
              <p class="tip">累计销售出库SKU数量</p>
              <p class="number">{{allData.skuCount}}个</p>
            </div>
          </el-col>
          <el-col :span="7" :offset="1">
            <div class="count">
              <p class="tip">累计销售出库商品数量</p>
      ...
      <div class="gc-praiselist_content_list" style="margin-top:15px;">
        <el-tabs v-model="activeName">
          <el-tab-pane label="商品销售出库汇总表" name="1">
          ...
          <el-tab-pane label="商品销售出库明细表" name="2">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      printTotal() {
        let time = this.getSelectTime();
        let url = "/api/report-pdf/sale-summary/商品销售出库汇总表.pdf";
        let params = {};
        params.beginDate = time.beginDate;
        params.endDate = time.endDate;
        params.types = '1';
      ...
      printDetail() {
        let time = this.getSelectTime();
        let url = "/api/report-pdf/sale-details/商品销售出库明细表.pdf";
        let params = {};
        params.beginDate = time.beginDate;
        params.endDate = time.endDate;
        params.types = '1';
