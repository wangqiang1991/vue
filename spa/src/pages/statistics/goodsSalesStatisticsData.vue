    ...
    <div id="putStorageStatistics_vue" class="app-container calendar-list-container">
      ...
      <div class="gc-praiselist_content_list" style="margin-top:15px;">
        ...
        <el-row :gutter="24" style="margin-bottom:10px;">
          <el-col :span="5">
            <div class="count">
              <p class="tip">销售总收入</p>
              <p class="number">¥{{(allData.saleMoney / 100).toFixed(2)}}元</p>
            </div>
          </el-col>
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">销售总成本</p>
              <p class="number">¥{{(allData.saleCostMoney / 100).toFixed(2)}}元</p>
            </div>
          </el-col>
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">销售总利润</p>
              <p class="number">¥{{(allData.saleProfit / 100).toFixed(2)}}元</p>
            </div>
          </el-col> 
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">销售总利润率</p>
              <p class="number">{{(allData.saleProfitRatio *  100).toFixed(2)}}%</p>
            </div>
          </el-col> 
        </el-row>
        ...
        <el-row :gutter="24" style="margin-bottom:10px;">
          ...
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">商品总成本</p>
              <p class="number">¥{{(allData.costMoney / 100).toFixed(2)}}元</p>
            </div>
          </el-col>
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">商品总利润</p>
              <p class="number">¥{{(allData.profit / 100).toFixed(2)}}元</p>
            </div>
          </el-col> 
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">商品总利润率</p>
              <p class="number">{{(allData.profitRatio * 100).toFixed(2)}}%</p>
            </div>
          </el-col> 
        </el-row>
        ...
        <el-row :gutter="24" >
          <el-col :span="5">
            <div class="count">
              <p class="tip">运费总收入</p>
              <p class="number">¥{{(allData.expressMoney / 100).toFixed(2)}}元</p>
            </div>
          </el-col>
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">运费总成本</p>
              <p class="number">¥{{(allData.realityExpressMoney / 100).toFixed(2)}}元</p>
            </div>
          </el-col>
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">运费总利润</p>
              <p class="number">¥{{(allData.expressProfit / 100).toFixed(2)}}元</p>
            </div>
          </el-col> 
          <el-col :span="5" :offset="1">
            <div class="count">
              <p class="tip">运费总利润率</p>
              <p class="number">{{(allData.expressProfitRatio * 100).toFixed(2)}}%</p>
            </div>
          </el-col> 
        </el-row>
      ...
      <div class="gc-praiselist_content_list" style="margin-top:15px;">
        <el-tabs v-model="activeName">
          <el-tab-pane label="商品销售数据汇总表" name="1">
          ...
          <el-tab-pane label="商品销售数据明细表" name="2">
  ...
  export default {
    ...
    methods:{
      ...
      findAllData() {
        ...
        params.types = 1;
        this.http.get(this).url(this.config.statistics.goodsSalesStorageStatistics_total).params(params).request((response) => {
      ...
      printTotal() {
        let time = this.getSelectTime();
        let url = "/api/report-pdf/sale-report-summary/商品销售数据汇总表.pdf";
        let params = {};
        params.beginDate = time.beginDate;
        params.endDate = time.endDate;
      ...
      printDetail() {
        let time = this.getSelectTime();
        let url = "/api/report-pdf/sale-report-details/商品销售数据明细表.pdf";
        let params = {};
        params.beginDate = time.beginDate;
        params.endDate = time.endDate;
        params.economy = false;
