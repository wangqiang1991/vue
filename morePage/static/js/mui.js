 ...
 * @type _L4.$|Function
 */
var superSlideNumber = undefined;
...
(function($, window, document, undefined) {
  ...
  var Scroll = $.Class.extend({
    ...
    scrollTo: function(x, y, time, easing, noclear) {
      // 非指定跳转的时候要清理superSlideNumber参数，不然到第一页会自动跳转到superSlideNumber的页面
      if (!noclear) {
        superSlideNumber = undefined;
      }
  ...
  var Slider = $.Slider = $.Scroll.extend({
    ...
    _initSnap: function() {
      ...
      if (!this.currentPage.x) {
        ...
        this.slideNumber = 0;
        //console.log(superSlideNumber, this.slideNumber, this);
        if (typeof superSlideNumber != 'undefined') {
          this.slideNumber = superSlideNumber;
        }
    ...
    _getPage: function(slideNumber, isFlick) {
      ...
      try {
        var page = this.pages[slideNumber][0];
        //console.log(page)
        return page;
      } catch(err) {
        //console.log(err);
        var page = this.pages[0][slideNumber];
       // console.log(page)
        return page;
      } 
    },
    _gotoItem: function(slideNumber, time) {
      ...
      if (slideNumber != 0 ) {
        if (this.currentPage.x == 0) {
          this.currentPage.x = -1 * document.body.clientWidth * slideNumber;
          superSlideNumber = slideNumber;
        }
      }
      
      this.scrollTo(this.currentPage.x, 0, time, this.options.scrollEasing, true);
      if (time === 0) {
        $.trigger(this.wrapper, 'scrollend', this);
      }
    },
