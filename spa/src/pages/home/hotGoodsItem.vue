<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <span style="color:#FF4949;margin-left: 10px;" type="text">最多添加6条</span>

    </div>

    <el-table :data="dataList" v-loading.body="listQuery.loading" border fit highlight-current-row style="width: 100%" id="hotGoodsTable">
      <el-table-column type="index" align="center" label="序号" width="65">
      </el-table-column>

      <el-table-column  label="商品名称">
        <template scope="scope">
          <span>{{scope.row.detail.title}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column  align="center" label="商品编码">
        <template scope="scope">
          <span>{{scope.row.detail.goodsNumber}}</span>
        </template>
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      findAll() {
        ...
        this.http.get(this).url(config.home.home_hot_goods_list).request(function (response) {
      ...
      setSort() {
        const el = document.querySelectorAll('#hotGoodsTable>.el-table__body-wrapper > table > tbody')[0];
      ...
      handleEdit(item) {
        ...
        this.homeTop.type = 6;
        this.homeTop.title = this.homeTop.detail.title;
        this.homeTop.goodsNumber = this.homeTop.detail.goodsNumber;
      ...
      findByPage() {
        ...
        this.http.get(this).url(config.goods.list_url_v2).params(params).request(function(response) {
