<template>
  <el-dialog title="选择点赞商品" :visible.sync="selectDialogFormVisible" :before-close="handleClose">
    <div style="margin-bottom:10px; text-align:right;">
      <el-input @keyup.enter.native="keyEvent()" v-model="goodsQuery.keyword" style="width: 200px;" class="filter-item"
                placeholder="输入名称或编号">
      </el-input>
    ...
    <el-table v-if="!multiple" :data="goodsList" @selection-change="handleSelectionChange" style="width: 100%" border>
      ...
      <el-table-column prop="goods" label="封面" align="center" vertical="middle" width="120">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button v-if="multiple" type="primary" @click="confirmSelectedGoods">确 定</el-button>
    </div>
  </el-dialog>
</template>
<script>
